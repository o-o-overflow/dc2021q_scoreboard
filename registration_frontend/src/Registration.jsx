  ...
  render() {
    ...
    return (
      <div>
        ...
        <div className="form-group">
          <label htmlFor="ctf-time-team-id">
            CTF Time Team ID
            <br />
            <input
              id="ctf-time-team-id"
              ...
              readOnly={this.state.buttonDisabled}
              type="number"
              value={this.state.ctfTimeTeamId}
            />
          </label>
          <div className="small">
            The 762 part of a URL like:{" "}
            <a href="https://ctftime.org/team/762">
        ...
        <div className="form-group">
          <label htmlFor="password">
            ...
            <input
              ...
              onKeyPress={this.handleKeyPress}
              placeholder="10 to 72 characters"
              readOnly={this.state.buttonDisabled}
              type="password"
